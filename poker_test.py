...
class TestPoker(unittest.TestCase):
  def test_helpers(self):
    ...
    self.assertEqual(better_hand([2,3,4,5,6], [2,3,4,5,6]), False)
    self.assertEqual(better_hand([3,3,4,5,6], [2,3,4,5,6]), True)
    self.assertEqual(better_hand([2,3,4,5,ACE], [2,3,4,5,6]), True)
    self.assertEqual(better_hand([2,3,4,JOKER,6], [2,3,4,5,6]), True)
    self.assertEqual(better_hand([JOKER,3,4,5,6], [ACE,3,4,5,6]), False)
  ...
  def test_straight(self):
    self.assertEqual(get_straight(5, [2,4,3,6,5,ACE,KING]), [6,5,4,3,2])
    self.assertEqual(get_straight(5, [2,3,7,5,6,ACE,KING,QUEEN]), [])
    self.assertEqual(get_straight(5, [2,4,5,ACE,QUEEN,JACK], num_jokers=1), [5,4,JOKER,2,ACE])
    self.assertEqual(get_straight(5, [2,4,ACE,10,JACK], num_jokers=2), [ACE,JOKER,JOKER,JACK,10])
    self.assertEqual(get_straight(5, [2,3,4,5,6,7,8,9,10,JACK,QUEEN,KING,ACE]), [ACE,KING,QUEEN,JACK,10])
    self.assertEqual(get_straight(5, [], num_jokers=5), [JOKER,JOKER,JOKER,JOKER,JOKER])
    self.assertEqual(get_straight(5, [2,4,3,6]), [])
  ...
  def test_straight_flush(self):
    ...
    self.assertEqual(get_straight_flush(5, hand), [6,5,4,3,2])
    hand = [(2, 'diamond'), (3, 'heart'), (4, 'heart'), (5, 'heart'), (6, 'heart'), (ACE, 'heart')]
    self.assertEqual(get_straight_flush(5, hand), [])
    hand = [(2, 'heart'), (3, 'heart'), (5, 'heart'), (6, 'heart'), (ACE, 'heart')]
    self.assertEqual(get_straight_flush(5, hand, num_jokers=1), [6,5,JOKER,3,2]) # ambiguous joker placement

  def test_royal_flush(self):
    hand = [(2, 'heart'), (3, 'heart'), (4, 'heart'), (5, 'heart'), (6, 'heart'), (ACE, 'heart')]
    self.assertEqual(get_royal_flush(5, hand), [])
    hand = [(ACE, 'heart'), (KING, 'heart'), (QUEEN, 'heart'), (JACK, 'heart'), (10, 'heart'), (ACE, 'diamond')]
    self.assertEqual(get_royal_flush(5, hand), [ACE,KING,QUEEN,JACK,10])
    self.assertEqual(get_royal_flush(5, hand, num_jokers=5), [ACE,KING,QUEEN,JACK,10])
    self.assertEqual(get_royal_flush(5, [], num_jokers=5), [JOKER,JOKER,JOKER,JOKER,JOKER])
